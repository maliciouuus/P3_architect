                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" value={name} onChange={(e) => setName(e.target.value)}
                                ...
                                className="h-10 w-full rounded-lg border border-zinc-300 dark:border-zinc-600
                                           ...
                                           focus:outline-none focus:ring-2 focus:ring-zinc-800 dark:focus:ring-zinc-200 transition" />
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <input type={showPwd ? 'text' : 'password'} value={password}
                                    ...
                                    className="h-10 w-full rounded-lg border border-zinc-300 dark:border-zinc-600
                                               bg-white dark:bg-zinc-800 px-3 pr-10 text-sm text-zinc-900 dark:text-zinc-100
                                               placeholder:text-zinc-400 dark:placeholder:text-zinc-500
                                               focus:outline-none focus:ring-2 focus:ring-zinc-800 dark:focus:ring-zinc-200 transition" />
